...
function Guard(bot) {
    ...
    function moveToGuardPos() {
        bot.pathfinder.setGoal(new GoalBlock(modeoptions.pos.x, modeoptions.pos.y, modeoptions.pos.z))
    }
    function followGuardEntity() {
        const goal = new GoalFollow(modeoptions.entity, come ? 0 : 3)
